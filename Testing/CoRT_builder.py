...
class CoRT:
    ...
    def find_similar_source(self, n_target, K, target_data, source_data, T, verbose=False):
        ...
        for t in range(T):
            ...
            model_0 = Lasso(alpha=self.alpha, **setting.lasso_config)
            ...
            for k in range(K):
                ...
                model_0k = Lasso(alpha=self.alpha, **setting.lasso_config)
