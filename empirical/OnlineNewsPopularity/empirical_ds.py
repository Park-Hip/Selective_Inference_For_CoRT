...
def run():
    ...
    for i in range(iteration):
        ...
        try:
            result = data_splitting_empirical(p, K, T, CONST_C, beta_index_list, target_data, source_data, n_target = 50, n_source = 100)
        except ValueError as e:
            print(f"Value Error in iteration {i+1}: {e}")
            continue
